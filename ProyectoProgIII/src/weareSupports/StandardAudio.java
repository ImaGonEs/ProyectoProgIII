package weareSupports;
	...
	/**
	 * This class was incredibly painful to construct, but in essence, it uses both pure Java,
	 * and the JavaFX libraries to playback sounds. The JavaFX library is utilized more for 
	 * long playback songs, such as the game's soundtracks, and whatnot. The pure Java library
	 * is used for more repetitive sound effects, that need to be played very quickly; JavaFX
	 * does not have a very effective way of playing back sounds quickly.
	 * 
	...
	public class StandardAudio{
		...
		/**
		 * Resets and plays the sound effect,
		 * ONLY FOR JAVA2D SFX
		 */
		public void rAndP(){
